package com.ertugrulsarioglu.kotlinogrenmeprojesi
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Başlatma, Değerini Atama (Initializing, Intitialization)
        benimIntegerim = 5
        ...
        val benimDizim = arrayOf(stringOrnegi,"Atıl","Samancıoğlu","Ertuğrul","Osman","Kerem")
        ...
        val kaloriDizisi = arrayOf(150,500,300)
        ...
        if (skor<10){
            ...
            println("Skorun 20 ve 30 arasında çok iyisin başkan")
        }
        else{
            println("Skorun 30'un üstünde. Rekor kırdın müdür.")
        }
        ...
        */
        ...
        benimDigerStringDizim.add("Ertuğrul")
        benimDigerStringDizim.add("Sarı")
